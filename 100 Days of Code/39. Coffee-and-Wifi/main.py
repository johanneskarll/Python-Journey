...
class CafeForm(FlaskForm):
    ...
    location = URLField('Cafe Location URL', validators=[DataRequired()])
...
def add_cafe():
    ...
    # with   if form.validate_on_submit()
        with open('39. Coffee-and-Wifi/cafe-data.csv', mode="a", encoding='utf-8') as csv_file:
            csv_file.write(f"\n{form.cafe.data},"
...
@app.route('/cafes')
def cafes():
    with open('39. Coffee-and-Wifi/cafe-data.csv', newline='', encoding='utf-8') as csv_file:
